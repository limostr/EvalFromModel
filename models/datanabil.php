...
,'Model'=>
    ...
    ,'form'=>array(
        "{Licence:AutreInformations:@titre}"=>array(
            ...
            ,"name"=>"{Licence:AutreInformations:@titre}"
            ,"label"=>"Titre: "
        ...
        "{Licence:AutreInformations:@nbrredouble}"=>array(
            ...
            ,"options"=>array(
                ...
                ,"name"=>"{Licence:AutreInformations:@nbrredouble}"
...
include(dirname(__FILE__)."/datanabilMetrise.php");
include(dirname(__FILE__)."/datanabilIngenieur.php");
/*echo "<pre>";
print_r($Licence);
echo "</pre>";*/
$_Model_Eval['Licence']=$Licence;
$_Model_Eval['Metrise']=$Metrise;
